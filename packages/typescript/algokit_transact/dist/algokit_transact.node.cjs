...
var algokit_transact_ffi = {exports: {}};

algokit_transact_ffi.exports;

var hasRequiredAlgoKit_transact_ffi;

function requireAlgoKit_transact_ffi () {
	if (hasRequiredAlgoKit_transact_ffi) return algokit_transact_ffi.exports;
	hasRequiredAlgoKit_transact_ffi = 1;
	(function (module) {
		let imports = {};
		...
		const path = require$$1.join(__dirname, 'algokit_transact_ffi_bg.wasm');
	...
	return algokit_transact_ffi.exports;
}

requireAlgoKit_transact_ffi();
